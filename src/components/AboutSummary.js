...
const AboutSummary = () => (
  <div className="about-summary-main">
    ...
    <p>Name: <span>Olapetan Olawale</span></p>
    <p>Tel: <span>+234 - 803 - 241 - 5315</span></p>
    <p>Email: <span><a href="mailto:olapetanwale@outlook.com" >olapetanwale@outlook.com</a></span></p>
  </div>
);
